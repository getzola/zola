...
fn can_highlight_code_block_no_lang() {
    ...
    assert_eq!(
        res.body,
        "<pre style=\"background-color:#2b303b;color:#c0c5ce;\"><code>$ gutenberg server\n$ ping\n</code></pre>"
    );
}
...
fn can_highlight_code_block_with_lang() {
    ...
    assert_eq!(
        res.body,
        "<pre style=\"background-color:#2b303b;color:#c0c5ce;\"><code class=\"language-python\" data-lang=\"python\">list.<span style=\"color:#bf616a;\">append</span>(<span style=\"color:#d08770;\">1</span>)\n</code></pre>"
    );
}
...
fn can_higlight_code_block_with_unknown_lang() {
    ...
    assert_eq!(
        res.body,
        "<pre style=\"background-color:#2b303b;color:#c0c5ce;\"><code class=\"language-yolo\" data-lang=\"yolo\">list.append(1)\n</code></pre>"
    );
}
