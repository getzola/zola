...
pub fn format_svg(
    ...
    if render_mode == MathRenderMode::Raw {
    ...
    format!(
            ...
            match render_mode {
                MathRenderMode::Display | MathRenderMode::Raw => "typst-display",
                MathRenderMode::Inline => "typst-inline",
            },
