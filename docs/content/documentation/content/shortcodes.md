...
If you want to use something similar to shortcodes in your templates, you can use [Tera macros](https://keats.github.io/tera/#macros). They are functions or components that you can call to return some text.
