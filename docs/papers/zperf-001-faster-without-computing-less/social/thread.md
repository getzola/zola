...
The real site: −35.1% CPU.

**3/**
We ran that comparison twice. The CPU figure came back within half a point of
itself; the wall figure moved 7 points and did not reproduce. Two runs of the
*same* binary gave 31.8 s and 36.8 s. Wall time on a shared desktop measures
the desktop.
