...
complete -c gutenberg -n "__fish_using_command gutenberg build" -s o -l outpt-dir -d 'Force the output dir to be that value (default is 'public')'
...
complete -c gutenberg -n "__fish_using_command gutenberg serve" -s o -l output-dir -d 'Force the output dir to be that value'
