...
Any changes to Zola should focus on solving a problem that users of Zola are having.
...
Explain the proposal as if it was already included in Zola and you were teaching it to another user. That generally means:

- Introducing new named concepts.
- Explaining the feature largely in terms of examples.
- Explaining how Zola users should *think* about the feature, and how it should impact the way they use Zola. It should explain the impact as concretely as possible.
- If applicable, provide sample error messages, deprecation warnings, or migration guidance.
- If applicable, describe the differences between teaching this to existing Zola users and new Zola users.
- Discuss how this impacts the ability to read, understand, and maintain Zola sites. Code is read and modified far more often than written; will the proposed feature make sites easier to maintain?
...
be and how it would affect Zola and project as a whole in a holistic
